...
public class ReportTemplateServiceImpl implements ReportTemplateService{
	 ...
	 * {@inheritDoc} 
	 */
	public ReportQuery constructReportQuery(PieChartTemplate template) 
			throws ReportTemplateServiceException{
	...
	private List<String> constructPieChartTemplateRequiredFields(PieChartTemplate template) throws ReportTemplateServiceException{
		...
		if(StringUtils.isNotBlank(categoryField) && 
	 ...
	 * @throws ReportTemplateServiceException
	 */
	private ReportQuery constructJoinModelReportQuery(Model model, Map<String, String> aliasLookUpMap) 
		throws ReportTemplateServiceException{
		...
		for (Map.Entry<String, String> entry : aliasLookUpMap.entrySet()) {
			...
			for(int eIdx = 0; eIdx< expresses.length; eIdx++){
				//if expression belongs to the required column, retain for final query
	 ...
	 * @throws ReportTemplateServiceException
	 */
	private ReportQuery constructSimpleModelReportQuery(SimpleModel model, Map<String, String> aliasLookUpMap) 
		throws ReportTemplateServiceException{
	 ...
	 * @throws ReportTemplateServiceException 
	 */
	private List<String> constructCartesianChartTemplateRequiredFields(CartesianChartTemplate template) 
		throws ReportTemplateServiceException{
		List<String> requiredColumnList = new ArrayList<String>();
		...
		if(StringUtils.isNotBlank(modelDataLabelField) &&
		   StringUtils.isNotBlank(modelDataValueField) &&
		   StringUtils.isNotBlank(modelSeriesGroupField)){
	 ...
	 * @throws ReportTemplateServiceException 
	 */
	private Map<String, String> constructAliasLookupMap(Model model, List<String> requiredColumnList) 
		throws ReportTemplateServiceException{
